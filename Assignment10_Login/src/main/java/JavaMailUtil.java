...
public class JavaMailUtil {
    ...
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "1157982786@qq.com";
    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "gsuikocyrzvfigcc";
    // 发件人邮箱服务地址-修改为自己的
    ...
    public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html)
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "ycj", "UTF-8"));
        // 4、Subject:邮件主题
