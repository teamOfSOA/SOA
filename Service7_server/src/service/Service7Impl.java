...
public interface Service7Impl {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "showResult", targetNamespace = "http://service/", className = "service.ShowResult")
    @ResponseWrapper(localName = "showResultResponse", targetNamespace = "http://service/", className = "service.ShowResultResponse")
    @Action(input = "http://service/service7Impl/showResultRequest", output = "http://service/service7Impl/showResultResponse", fault = {
        @FaultAction(className = IOException_Exception.class, value = "http://service/service7Impl/showResult/Fault/IOException")
    })
